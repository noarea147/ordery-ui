...
export default function Home() {
  ...
  return (
    <main
      ...
      <div className="flex flex-col items-center justify-center w-full bg-gray-300 rounded-t-3xl">
        ...
        <div className="flex flex-col justify-start w-full">
          <h3
            className="text-lg font-bold text-left text-blue-500 p-5"
              ...
              showDrinks && (
                <div
                  ...
                  <div className="flex flex-row items-center justify-between w-full pr-6 pl-6 pt-3 pb-3">
                    <h4 className="text-md font text-center text-blue-500">
                      {drink.name}
                    </h4>
                    <p className="text-md font text-center text-blue-500">
                      {drink.price}
                    </p>
                  </div>
                </div>
