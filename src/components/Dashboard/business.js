          ...
          {business.length !== 0 ? (
            <>
              ...
              <li
                ...
                onClick={() => handleNavigateToBusiness("123124432432423")}>
        ...
        <div className="w-full">
          ...
          <form
            ...
            <div className="w-full">
              ...
              <div className="mt-2">
                <button className="flex w-[50vh] m-4 justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
                  Set location
                </button>
              </div>
            </div>
